  ...
  $scope.aceptarLlamada = function(data){
    ...
    */
    ...
    //if (user_logueado() && datos.nombreusuario!="") {
      ...
      var obj = {
          tablet_id : datos_llegada.tablet_id,
          vendedor_id : datos_llegada.turno.cola_vendedores[0],
          consecionario_id : datos_llegada.turno._id,
          user_id :  datos_llegada.user._id,
          car : datos_llegada.car
      }
